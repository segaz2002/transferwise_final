...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_53444475665ce4_44266747',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_53444475665ce4_44266747')) {function content_53444475665ce4_44266747($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
...
<div class="pageheader">
    <h2><i class="fa fa-table"></i> Revenue <span>Create a revenue source</span></h2>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title" id="myModalLabel">Offering</h4>
                                            </div>
                                            <div class="modal-body">
                                                offering  from all church services.
                                            </div>
                                ...
                                <div class="modal fade" id="2Modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                                <h4 class="modal-title" id="myModalLabel">Tithe</h4>
                                            </div>
                                            <div class="modal-body">
                                                This is 10% income of faithfull members. A ti
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                                <!--<button type="button" class="btn btn-primary">Save changes</button>-->
                                    ...
                                    <td>3</td>
                                    <td>Seed</td>
                                    <td>Seed offerings...</td>
                                    <td><a class="btn btn-warning" data-toggle="modal" data-target="#3Modal">View</a></td>
                                </tr>
                                <div class="modal fade" id="3Modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                                <h4 class="modal-title" id="myModalLabel">Seed</h4>
                                            </div>
                                            <div class="modal-body">
                                                Seed offerings from members.
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                                <!--<button type="button" class="btn btn-primary">Save changes</button>-->
