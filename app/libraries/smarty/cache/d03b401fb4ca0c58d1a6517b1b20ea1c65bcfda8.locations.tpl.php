...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_52bac7bccef463_04178323',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52bac7bccef463_04178323')) {function content_52bac7bccef463_04178323($_smarty_tpl) {?><!doctype html>
<html>
        ...
        <div class="span12">
            <div class="box box-bordered box-color green">
                ...
                <div class="box-content ">
                    ...
                    <iframe id="iframeBrowser" src="http://localhost/beta.gateway/settings/get_locations" class="span11" style="height: 630px;"></iframe>
                </div>
            </div>
        </div>
    </div>
