...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5344450e0ed8b6_62187722',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5344450e0ed8b6_62187722')) {function content_5344450e0ed8b6_62187722($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
...
<div class="pageheader">
    <h2><i class="fa fa-dollar"></i> Expenditure <span>Expenditure BreakDown for </span></h2>
    <div class="breadcrumb-wrapper">
        <span class="label">You are here:</span>
        <ol class="breadcrumb">
                            <li><a href="http://localhost/churchplus/projects/browse">Projects</a></li>
                            <li><a href="http://localhost/churchplus/expenditure/index">Expenditure</a></li>
        ...
        <div class="panel-body">
            <div class="row">
                ...
                <div class="col-sm-6 text-right">
                    ...
                    <p class="text-success"><strong>Opened Date:</strong> </p>
                    <p><strong class="badge badge-danger">Budget</strong> <span class="text text-info">0.00</span></p>
