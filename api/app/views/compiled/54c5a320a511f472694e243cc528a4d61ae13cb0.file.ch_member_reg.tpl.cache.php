<?php /* Smarty version Smarty-3.1.11, created on 2014-04-07 23:34:51
         compiled from "velo-admin/views/templates/pages/ch_member_reg.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18101016065343988bc62041-86982158%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '54c5a320a511f472694e243cc528a4d61ae13cb0' => 
    array (
      0 => 'velo-admin/views/templates/pages/ch_member_reg.tpl',
      1 => 1395958028,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '18101016065343988bc62041-86982158',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5343988bce5dd5_02597074',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5343988bce5dd5_02597074')) {function content_5343988bce5dd5_02597074($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
...
<div class="contentpanel">
	...
	<div class="row">
        ...
        <form class="" id="newMembershipForm">
		<div class="col-md-8">
			 <div class="panel panel-success">
			   <div class="panel-heading">
				 ...
				 <h4 class="panel-title">New Member Registration</h4>
			   ...
			   <div class="panel-body">
				 ...
				 <div class="row">
				   ...
				   <div class="col-sm-6">
					 <div class="form-group">
					   <label class="control-label">Telephone <span class="asterisk">*</span></label>
				  ...
				  <div class="row">
				   <div class="col-sm-8">
					 <div class="form-group">
					   <label class="control-label">Birth Date <span class="asterisk">*</span></label>
					   <input type="text" name="dob" class="form-control" placeholder="mm/dd/yyyy" id="datepicker" required>
					 </div>
				   </div><!-- col-sm-6 -->
				   <div class="col-sm-4">
					 <div class="form-group">
                       ...
                       <span class="asterisk">*</span>
					    <div class="rdio rdio-success">
							<input type="radio" name="gender" value="m" id="radiomale" required/>
							<label for="radiomale">Male</label>
						</div>
					   <div class="rdio rdio-success">
							<input type="radio" name="gender" value="f" id="radiofemale" />
				   ...
				   <div class="col-sm-8">
					 <div class="form-group">
					   <label class="control-label">Address upto to the last Bus Stop <span class="asterisk">*</span></label>
					   <textarea class="form-control" name="address"></textarea>
					 </div>
				   </div><!-- col-sm-6 -->
				   <div class="col-sm-4">
					 <div class="form-group">
					   <label class="control-label">Marital Status <span class="asterisk">*</span></label>
					    <div class="rdio rdio-success">
							<input type="radio" name="m_status" value="m" id="radiomarried" required/>
							<label for="radiomarried">Married</label>
						</div>
					   <div class="rdio rdio-success">
							<input type="radio" name="m_status" value="s" id="radiosingle" />
